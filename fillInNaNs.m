...
for setindx = 1:numSets
    ...
    afalwt_fit=afalwt(resps_gur{setindx},1-resps_tofill{setindx},opts);
    
    resps_gur_fitted=(afalwt_fit.x_true*afalwt_fit.b_norm+repmat(afalwt_fit.a,size(resps_gur{setindx},1),1)); %interpolated data
