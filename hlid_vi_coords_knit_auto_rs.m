...
% Savoing the workspace allows for replotting (e.g., otherp values for shuffle significance) pwithout recalculating 
%
...
hlid_setup;
%
if_havedata=getinp('1 to reuse an existing calculation (e.g., from hlid_vi_coords_knit_auto_rs_[avg].mat)','d',[0 1],exist('results_knit'));
if if_havedata
